<!--
  PlotCraft 角色设计 — Animated & Professional Edition
-->
<style>
...
.template-grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(150px, 1fr)); gap: 10px; margin: 10px 0 20px; }
.template-card { background: rgba(255,255,255,0.04); border: 1px solid rgba(255,255,255,0.08); border-radius: 10px; padding: 12px 14px; animation: slideUp 0.4s ease-out both; transition: transform 0.3s ease, border-color 0.3s ease; }
.template-card:hover { transform: translateY(-3px); border-color: rgba(255,107,53,0.35); }
.template-name { font-weight: 700; font-size: 0.85em; color: #FF6B35; margin-bottom: 3px; }
.template-desc { font-size: 0.78em; color: rgba(255,255,255,0.6); margin: 0; }
...
<div class="breadcrumb">← [文档首页](https://agions.github.io/PlotCraft) · [用户指南](./workflow-overview.md) · 渲染导出 →</div>

<div class="hero-banner"><div class="hero-title">🎭 角色设计</div><div class="hero-subtitle">为您的视频设计和管理角色</div></div>
...
<div class="template-grid">
  <div class="template-card"><div class="template-name">professional_male</div><div class="template-desc">商务装束、短发</div></div>
  <div class="template-card"><div class="template-name">professional_female</div><div class="template-desc">商务装束、各种发型</div></div>
  <div class="template-card"><div class="template-name">casual_youth</div><div class="template-desc">现代休闲装</div></div>
  <div class="template-card"><div class="template-name">fantasy_hero</div><div class="template-desc">史诗奇幻角色</div></div>
  <div class="template-card"><div class="template-name">sci_fi_crew</div><div class="template-desc">科幻太空船员</div></div>
  <div class="template-card"><div class="template-name">historical</div><div class="template-desc">时代适当的服装</div></div>
</div>

## 最佳实践

<div class="bp-grid">
  <div class="bp-item"><div class="bp-text">一致的参考：使用 3+ 参考图片以获得最佳一致性</div></div>
  <div class="bp-item"><div class="bp-text">清晰的描述：详细的描述有助于 AI 生成</div></div>
  <div class="bp-item"><div class="bp-text">表情多样性：为每个角色创建 4-6 个表情变体</div></div>
  <div class="bp-item"><div class="bp-text">语音匹配：将 TTS 语音与角色性格匹配</div></div>
</div>
